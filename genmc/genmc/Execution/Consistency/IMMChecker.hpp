...
private:
	...
	mutable std::vector<NodeStatus> visitedCalc75_0;
	mutable std::vector<NodeStatus> visitedCalc75_1;
	mutable std::vector<NodeStatus> visitedCalc75_2;
	mutable std::vector<NodeStatus> visitedCalc75_3;
	mutable std::vector<NodeStatus> visitedCalc75_4;
	mutable std::vector<NodeStatus> visitedCalc75_5;
	mutable std::vector<NodeStatus> visitedCalc75_6;

	bool visitCalc75_0(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_1(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_2(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_3(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_4(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_5(const EventLabel *lab, View &calcRes) const;
	bool visitCalc75_6(const EventLabel *lab, View &calcRes) const;
	...
	mutable std::vector<NodeStatus> visitedCalc87_0;
	mutable std::vector<NodeStatus> visitedCalc87_1;
	mutable std::vector<NodeStatus> visitedCalc87_2;

	bool visitCalc87_0(const EventLabel *lab, View &calcRes) const;
	bool visitCalc87_1(const EventLabel *lab, View &calcRes) const;
	bool visitCalc87_2(const EventLabel *lab, View &calcRes) const;
