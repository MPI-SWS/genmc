...
{
	ERROR("SmallVector unable to grow. Requested capacity ({}) "
...
{
	ERROR("SmallVector capacity unable to grow. Already at maximum size {}", MaxSize);
}
...
// Note: Moving this function into the header may cause performance regression.
template <class Size_T>
void *SmallVectorBase<Size_T>::mallocForGrow(void *FirstEl, size_t MinSize, size_t TSize,
					     size_t &NewCapacity)
{
...
template class genmc::SmallVectorBase<uint32_t>;
...
template class genmc::SmallVectorBase<uint64_t>;
