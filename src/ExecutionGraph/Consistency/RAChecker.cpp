...
bool RAChecker::visitCalc62_0(const EventLabel *lab, View &calcRes) const
{
...
bool RAChecker::visitCalc62_1(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc62_2(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
View RAChecker::visitCalc62(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
	View calcRes;
...
auto RAChecker::checkCalc62(const EventLabel *lab) const
{
	auto &g = *lab->getParent();

	return visitCalc62(lab);
}
bool RAChecker::visitCalc68_0(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_1(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_2(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_3(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_4(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_5(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitCalc68_6(const EventLabel *lab, View &calcRes) const
{
	auto &g = *lab->getParent();
...
View RAChecker::visitCalc68(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
	View calcRes;
...
auto RAChecker::checkCalc68(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitLHSUnlessError7_0(const EventLabel *lab) const
{
	auto &g = *lab->getParent();


visitedLHSUnlessError7Accepting[lab->getStamp().get()] = true;

	return true;
}

bool RAChecker::visitLHSUnlessError7_1(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitLHSUnlessError7_2(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitRHSUnlessError7_0(const EventLabel *lab) const
{
	auto &g = *lab->getParent();


visitedRHSUnlessError7Accepting[lab->getStamp().get()] = true;

	return true;
}

bool RAChecker::visitRHSUnlessError7_1(const EventLabel *lab) const
{
	auto &g = *lab->getParent();

	if (visitedRHSUnlessError7_1[lab->getStamp().get()] != NodeStatus::unseen)
		return true;
	visitedRHSUnlessError7_1[lab->getStamp().get()] = NodeStatus::entered;

	for (auto &tmp : g.rf_succs(lab)) if (auto *pLab = &tmp; true) {
			if (!visitRHSUnlessError7_0(pLab)){
			return false;
		}
	...
	for (auto &tmp : g.rf_succs(lab)) if (auto *pLab = &tmp; true) {
		auto status = visitedRHSUnlessError7_1[pLab->getStamp().get()];
		if (status == NodeStatus::unseen) {
			if (!visitRHSUnlessError7_1(pLab)){
			return false;
		}
	...
	visitedRHSUnlessError7_1[lab->getStamp().get()] = NodeStatus::left;
	return true;
}

bool RAChecker::visitRHSUnlessError7_2(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitRHSUnlessError7_3(const EventLabel *lab) const
{
	auto &g = *lab->getParent();


	if (auto pLab = g.po_imm_pred(lab); pLab) {
			if (!visitRHSUnlessError7_2(pLab)){
			return false;
		}
...
bool RAChecker::visitRHSUnlessError7_4(const EventLabel *lab) const
{
	auto &g = *lab->getParent();


	if (auto pLab = g.po_imm_pred(lab); pLab)if (true && genmc::isa<HpProtectLabel>(pLab)) {
			if (!visitRHSUnlessError7_3(pLab)){
			return false;
		}

	}
	if (auto pLab = g.po_imm_pred(lab); pLab) {
			if (!visitRHSUnlessError7_4(pLab)){
			return false;
		}
...
bool RAChecker::visitUnlessError7(const EventLabel *lab) const
{
	...
	visitedRHSUnlessError7_1.clear();
	visitedRHSUnlessError7_1.resize(g.getMaxStamp().get() + 1, NodeStatus::unseen);
...
bool RAChecker::visitError8(const EventLabel *lab) const
{
	return false;
}

bool RAChecker::visitLHSUnlessError8_0(const EventLabel *lab, const View &v) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitLHSUnlessError8_1(const EventLabel *lab, const View &v) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitUnlessError8(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::checkError8(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitWarning9(const EventLabel *lab) const
{
	return false;
}

bool RAChecker::visitLHSUnlessWarning9_0(const EventLabel *lab, const View &v) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitLHSUnlessWarning9_1(const EventLabel *lab, const View &v) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::visitUnlessWarning9(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
...
bool RAChecker::checkWarning9(const EventLabel *lab) const
{
	auto &g = *lab->getParent();
