...
void SCDriver::visitCalc0_0(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void SCDriver::visitCalc0_1(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void SCDriver::visitCalc0_2(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
View SCDriver::calculate0(const EventLabel *lab)
{
	auto &g = getGraph();
	View calcRes;
...
bool SCDriver::isDepTracking() const { return 0; }

bool SCDriver::visitInclusionLHS0_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS0_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion0(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void SCDriver::visitInclusionLHS1_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void SCDriver::visitInclusionLHS1_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS2_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS2_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS2_2(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion2(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void SCDriver::visitInclusionLHS3_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void SCDriver::visitInclusionLHS3_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void SCDriver::visitInclusionLHS3_2(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion3(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS4_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS4_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::visitInclusionLHS4_2(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion4(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void SCDriver::visitInclusionLHS5_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void SCDriver::visitInclusionLHS5_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void SCDriver::visitInclusionLHS5_2(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::checkInclusion5(const EventLabel *lab) const
{
	auto &g = getGraph();
...
SCDriver::checkWarnings(const EventLabel *lab, const VSet<VerificationError> &seenWarnings,
...
bool SCDriver::visitAcyclic0_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool SCDriver::isAcyclic0(const EventLabel *lab) const
{
	auto &g = getGraph();
	...
	return true && visitAcyclic0_0(lab);
}

bool SCDriver::isConsistent(const EventLabel *lab) const { return true && isAcyclic0(lab); }

bool SCDriver::isRecAcyclic(const EventLabel *lab) const
{
	visitedRecAccepting = 0;
	return true;
}

bool SCDriver::isRecoveryValid(const EventLabel *lab) const { return isRecAcyclic(lab); }
...
const View &SCDriver::getHbView(const EventLabel *lab) const { return lab->view(0); }
...
std::vector<Event> SCDriver::getInitRfsAtLoc(SAddr addr)
{
...
ExecutionGraph::co_iterator SCDriver::splitLocMOBefore(SAddr addr, Event e)
{
	auto &g = getGraph();
...
ExecutionGraph::co_iterator SCDriver::splitLocMOAfterHb(SAddr addr, const Event read)
{
	auto &g = getGraph();
...
ExecutionGraph::co_iterator SCDriver::splitLocMOAfter(SAddr addr, const Event e)
{
	auto &g = getGraph();
...
std::vector<Event> SCDriver::getCoherentStores(SAddr addr, Event read)
{
	auto &g = getGraph();
...
std::vector<Event> SCDriver::getMOOptRfAfter(const WriteLabel *sLab)
{
...
std::vector<Event> SCDriver::getMOInvOptRfAfter(const WriteLabel *sLab)
{
	auto &g = getGraph();
	std::vector<Event> after;
	std::vector<const ReadLabel *> rfAfter;
...
std::vector<Event> SCDriver::getCoherentRevisits(const WriteLabel *sLab, const VectorClock &pporf)
{
	auto &g = getGraph();
