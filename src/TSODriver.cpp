...
void TSODriver::visitCalc0_0(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void TSODriver::visitCalc0_1(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void TSODriver::visitCalc0_2(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
View TSODriver::calculate0(const EventLabel *lab)
{
	auto &g = getGraph();
	View calcRes;
...
void TSODriver::visitCalc1_0(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void TSODriver::visitCalc1_1(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
void TSODriver::visitCalc1_2(const EventLabel *lab, View &calcRes)
{
	auto &g = getGraph();
...
View TSODriver::calculate1(const EventLabel *lab)
{
	auto &g = getGraph();
	View calcRes;
...
std::vector<VSet<Event>> TSODriver::calculateSaved(const EventLabel *lab)
{
	return std::move(saved);
}

std::vector<View> TSODriver::calculateViews(const EventLabel *lab)
{
...
bool TSODriver::isDepTracking() const { return 0; }

bool TSODriver::visitInclusionLHS0_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS0_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion0(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void TSODriver::visitInclusionLHS1_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void TSODriver::visitInclusionLHS1_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS2_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS2_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS2_2(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion2(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void TSODriver::visitInclusionLHS3_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void TSODriver::visitInclusionLHS3_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void TSODriver::visitInclusionLHS3_2(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion3(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS4_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS4_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS4_2(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion4(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
void TSODriver::visitInclusionLHS5_0(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void TSODriver::visitInclusionLHS5_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
void TSODriver::visitInclusionLHS5_2(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion5(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS6_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS6_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion6(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(0);
...
bool TSODriver::visitInclusionLHS7_0(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::visitInclusionLHS7_1(const EventLabel *lab, const View &v) const
{
	auto &g = getGraph();
...
bool TSODriver::checkInclusion7(const EventLabel *lab) const
{
	auto &g = getGraph();
	auto &v = lab->view(1);
...
TSODriver::checkWarnings(const EventLabel *lab, const VSet<VerificationError> &seenWarnings,
...
bool TSODriver::visitAcyclic0_0(const EventLabel *lab) const
{
	auto &g = getGraph();
	...
	if (auto pLab = po_imm_pred(g, lab); pLab)
		if (true && llvm::isa<ThreadJoinLabel>(pLab)) {
			auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
			if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
				return false;
			else if (node.status == NodeStatus::entered &&
	...
	if (auto pLab = po_imm_pred(g, lab); pLab)
		if (true && llvm::isa<ThreadStartLabel>(pLab)) {
			auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
			if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
				return false;
			else if (node.status == NodeStatus::entered &&
...
bool TSODriver::visitAcyclic0_1(const EventLabel *lab) const
{
	auto &g = getGraph();
...
bool TSODriver::visitAcyclic0_2(const EventLabel *lab) const
{
	auto &g = getGraph();

	visitedAcyclic0_2[lab->getStamp().get()] = {visitedAccepting0, NodeStatus::entered};
	if (auto pLab = po_imm_pred(g, lab); pLab)
		if (true && pLab->isSC() && llvm::isa<WriteLabel>(pLab)) {
			auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
			if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
				return false;
			else if (node.status == NodeStatus::entered &&
...
bool TSODriver::visitAcyclic0_3(const EventLabel *lab) const
{
	auto &g = getGraph();
	...
	if (true && lab->isSC() && llvm::isa<ReadLabel>(lab))
		if (auto pLab = po_imm_pred(g, lab); pLab)
			if (true && pLab->isSC() && llvm::isa<WriteLabel>(pLab)) {
				auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
				if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
	...
	if (true && llvm::isa<ThreadCreateLabel>(lab))
		if (auto pLab = po_imm_pred(g, lab); pLab) {
			auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
			if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
				return false;
	...
	if (true && llvm::isa<ThreadFinishLabel>(lab))
		if (auto pLab = po_imm_pred(g, lab); pLab) {
			auto &node = visitedAcyclic0_3[pLab->getStamp().get()];
			if (node.status == NodeStatus::unseen && !visitAcyclic0_3(pLab))
				return false;
...
bool TSODriver::isAcyclic0(const EventLabel *lab) const
{
	auto &g = getGraph();
	...
	return true && visitAcyclic0_3(lab);
}

bool TSODriver::isConsistent(const EventLabel *lab) const { return true && isAcyclic0(lab); }

bool TSODriver::isRecAcyclic(const EventLabel *lab) const
{
	visitedRecAccepting = 0;
	return true;
}

bool TSODriver::isRecoveryValid(const EventLabel *lab) const { return isRecAcyclic(lab); }
...
const View &TSODriver::getHbView(const EventLabel *lab) const { return lab->view(0); }
...
std::vector<Event> TSODriver::getInitRfsAtLoc(SAddr addr)
{
...
ExecutionGraph::co_iterator TSODriver::splitLocMOBefore(SAddr addr, Event e)
{
	auto &g = getGraph();
...
ExecutionGraph::co_iterator TSODriver::splitLocMOAfterHb(SAddr addr, const Event read)
{
	auto &g = getGraph();
...
ExecutionGraph::co_iterator TSODriver::splitLocMOAfter(SAddr addr, const Event e)
{
	auto &g = getGraph();
...
std::vector<Event> TSODriver::getCoherentStores(SAddr addr, Event read)
{
	auto &g = getGraph();
...
std::vector<Event> TSODriver::getMOOptRfAfter(const WriteLabel *sLab)
{
...
std::vector<Event> TSODriver::getMOInvOptRfAfter(const WriteLabel *sLab)
{
	auto &g = getGraph();
	std::vector<Event> after;
	std::vector<const ReadLabel *> rfAfter;
...
std::vector<Event> TSODriver::getCoherentRevisits(const WriteLabel *sLab, const VectorClock &pporf)
{
	auto &g = getGraph();
