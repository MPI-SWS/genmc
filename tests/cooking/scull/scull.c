...
#define __VERIFIER_nondet_int() 42
...
atomic_int scull_quantum = SCULL_QUANTUM;
atomic_int scull_qset = SCULL_QSET;
atomic_int dev_data;
atomic_int dev_quantum;
atomic_int dev_qset;
atomic_ulong dev_size;
atomic_int __X__; //variable to test mutual exclusion
